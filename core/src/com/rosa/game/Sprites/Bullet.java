...
public class Bullet extends Sprite {
    ...
    public Bullet(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        for(int i = 0; i < 4; i++){
            frames.add(new TextureRegion(screen.getAtlas().findRegion("keen"), 0, 0, 23, 32));
        }
    ...
    public void defineFireBall(){
        ...
        bdef.position.set(fireRight ? getX() + 12 /AndroidJDEV.PPM : getX() - 12 /AndroidJDEV.PPM, getY());
        ...
        shape.setRadius(3 / AndroidJDEV.PPM);
