    ...
    public void beginContact(Contact contact) {
        ...
        switch (cDef){
            ...
            case AndroidJDEV.MARIO_HEAD_BIT | AndroidJDEV.COIN_BIT:
                ...
                break;
            case AndroidJDEV.ENEMY_HEAD_BIT | AndroidJDEV.MARIO_BIT:
            ...
            case AndroidJDEV.ENEMY_BIT | AndroidJDEV.OBJECT_BIT:
                ...
                break;
            case AndroidJDEV.MARIO_BIT| AndroidJDEV.ENEMY_BIT:
                if(fixA.getFilterData().categoryBits == AndroidJDEV.MARIO_BIT)
            ...
            case AndroidJDEV.ITEM_BIT | AndroidJDEV.OBJECT_BIT:
                ...
                break;
            case AndroidJDEV.ITEM_BIT | AndroidJDEV.MARIO_BIT:
                if(fixA.getFilterData().categoryBits == AndroidJDEV.ITEM_BIT)
